...
struct FSplineCurves
{
	...
	/** Spline built from up vector data. Makes Rotation spline obsolete. */
	UPROPERTY()
	FInterpCurveVector UpVector;
	...
	{
		return Position == Other.Position && UpVector == Other.UpVector && Rotation == Other.Rotation && Scale == Other.Scale;
	}
...
class USplineComponent : public UPrimitiveComponent
{
	...
	UPROPERTY()
	FInterpCurveVector SplineUpVInfo_DEPRECATED;
...
public:
	...
	FInterpCurveVector& GetSplinePointsUpVector() { return SplineCurves.UpVector; }
	const FInterpCurveVector& GetSplinePointsUpVector() const { return SplineCurves.UpVector; }
	...
	//void CheckAndGenUpVectorSplineFromRotation();
...
private:
	...
	static ENGINE_API const FInterpCurvePointVector DummyPointUpVector;
